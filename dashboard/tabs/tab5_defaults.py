        ...
        if var1 and var2 and var1 != var2:
            ...
            if series_x.nunique() <= 1 or series_y.nunique() <= 1:
                ...
                interpretation = (
                    ...
                    f"{'🡺 ' + var1 + ' may lead ' var2 + 'with ' + best_lag + ' months of antecipation' if best_lag > 0 else '🡸 ' + var2 + ' may lead ' + var1 if best_lag < 0 else '⏸️ No temporal lead-lag detected. Theres is no evidence that one variable anticipates the other or the other following the other one in time.'}"
                )
